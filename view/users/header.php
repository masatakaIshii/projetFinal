<?php require_once('controller/users/verification.php'); ?>
<header>	
...
function headerAdmin(){
	?>
		...
		<li class="nav-item">
			<a class="nav-link active text-dark" href="index.php?action=game&amp;direction=create">Create puzzles</a>
		</li>
	<?php
}
...
function headerUser(){
	?>
		...
		if(canCreatePuzzle($_SESSION['idUser']) == true)
		{ ?>
			<li class="nav-item">
				<a class="nav-link active text-dark" href="index.php?action=game&amp;direction=create">Create puzzles</a>
			</li> <?php
			...
			<li class="nav-item">
				<a class="nav-link active text-dark btn disabled" href="index.php?action=game&amp;direction=create">Create puzzles</a>
			</li> <?php
		}
}
